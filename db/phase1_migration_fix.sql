-- ============================================================
-- LEDGR Phase 1 Migration FIX
-- This is a SAFE re-runnable version of the full migration.
-- It handles the case where parts of the original migration
-- may have already run before the error at line 365.
--
-- Root cause: app_admins table has (id, email, created_at),
-- NOT (user_id, role). All admin checks use email.
-- ============================================================
...
DROP FUNCTION IF EXISTS get_today_summary(date);
...
--     app_admins uses email column, NOT user_id
-- ============================================================
...
-- ============================================================
-- 11. Admin RPC: list users (admin check by email via is_app_admin)
-- ============================================================
...
-- ============================================================
-- 16. Delete user data RPC (app_admins uses email, not user_id)
-- ============================================================
...
-- ============================================================
-- 17. Add reviewed_dates column to profiles
-- ============================================================
